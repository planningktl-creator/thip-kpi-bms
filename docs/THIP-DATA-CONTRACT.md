...
When the source-view variable is empty, the app uses the initial HOSxP foundation query for `DH0101`, `DN0101`, `DR0101`, `CE0101`, `CI0101`, `DH0102`, `DG0202`, `DR0403`, `DR0102`, `DN0107`, `DH0112`, and `DN0109`. That query is limited to the definitions confirmed in the supplied THIP dictionary and is not a substitute for the remaining hospital-specific KPI rules.
